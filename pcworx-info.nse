...
action = function(host,port)
  local init_comms = string.pack("H","0101001a0000000078800003000c494245544830314e305f4d00")
  ...
  local pos, sid = string.unpack("C", response, 18)
  local init_comms2 = string.pack("HCH","0105001600010000788000", sid, "00000006000402950000")  
  ...
  local req_info = string.pack("HCH","0106000e00020000000000",sid,"0400")
  ...
  local pos, check1 = string.unpack("C",response,1)
  ...
  if(check1 == 0x81) then
    ...
    pos, output["PLC Type"] = string.unpack("z",response,31)
	pos, output["Model Number"] = string.unpack("z", response, 153)
	pos, output["Firmware Version"] = string.unpack("z",response, 67)
	pos, output["Firmware Date"] = string.unpack("z", response, 80)
	pos, output["Firmware Time"] = string.unpack("z", response, 92)
